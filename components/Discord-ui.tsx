...
import { Cog, Gift, Headphones, HelpCircle, Inbox, Menu, Mic, Phone, Pin, PlusCircle, Search, Smile, Sticker, UserCircle2, Video } from 'lucide-react';
    ...
    <div className="h-screen w-full flex flex-col items-center justify-center scale-[0.8] sm:scale-90 md:scale-100">
      <div className="m-2 lg:m-4 rounded-xl bg-opacity-25 dark:bg-opacity-25 p-2 lg:p-4 ring-1 ring-inset ring-gray-900/10 dark:ring-gray-100/10 max-w-[1240px] w-full">
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl mx-auto">
          ...
          <div className="hidden md:flex w-60 bg-[#2f3137] flex-col justify-between">
            <div>
              ...
              <div className="flex-1 overflow-y-auto pt-4">
                ...
                <div className='px-2 mb-4'>
                  ...
                  <div className='flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer'>
                    <Image src="/asset-profile-picture.jpeg" alt="KittyAt_Avt"
                      width={32}
                      height={32}
                      className='object-cover rounded-full mr-3'
                    />
                    <span className='font-medium'>KittyAt</span>
                  </div>
            ...
            <div className='p-2 bg-[#292b2f] flex items-center'>
              <div className='size-8 rounded-full bg-[#3659B1] mr-2' />
            ...
            <div className=' h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]'>
                <div className=' md:hidden mr-4'>
                 ...
                 <div className=' flex items-center'>
                  <div className='relative'>
                   ...
                   <p className=' font-semibold text-white'>KittyAt</p>
                 </div>
              ...
              <div className=' p-4'>
                <div className=' flex items-center bg-[#40444b] rounded-lg p-1'>
                    ...
                    <input readOnly type='text' placeholder='Message @KittyAt'
                    ...
                    <div className=' flex items-center space-x-3 mx-3 text-[#b9bbbe]'>
                      <Gift className='sizw-5 hover:text-white cursor-not-allowed hidden sm:block' />
                      <Sticker className='sizw-5 hover:text-white cursor-not-allowed hidden sm:block' />
                      <Smile className='sizw-5 hover:text-white cursor-not-allowed hidden sm:block' />
                    </div>
                </div>
              </div>
           </div>
