...
import { FiLoader, FiUpload, FiUser, FiMail, FiKey, FiShield } from 'react-icons/fi'
...
const Profile = () => {
    ...
    const profileItems = [
        ...
        { icon: <FiKey className="w-5 h-5" />, label: 'User ID', value: data?.id },
    ...
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/50 p-8"
        >
