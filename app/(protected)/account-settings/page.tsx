    ...
    <div className="h-screen w-full  bg-gray-50 flex">
      ...
      <div className="flex-1 h-screen w-full">
        <AnimatePresence mode='wait'>
          ...
          {
            activeSection === '2FAuthentication' && (
                <TwoFactorAuth/>
            )
          }
...
const ToggleSwitch = ({ label, checked, onChange }: ToggleSwitchProps) => (
  <motion.div whileHover={{ scale: 1.02 }} className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200">
